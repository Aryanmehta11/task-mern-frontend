...
export const createTask = createAsyncThunk(
    ...
    async (taskData, thunkAPI) => {
        try {
            const token = thunkAPI.getState().auth.user.token; // Assuming auth slice is present in the Redux store
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(createTask.fulfilled, (state, action) => {
                ...
                state.tasks = [...state.tasks, action.payload]; // Immutably update tasks array
            })
